...
PLATFORMS=android-9
#此处需要修改
FFMPEGLib=f:/ProgramTool/OpenPro/KKPlayer/libarm/ffmpeg/lib/
BASELib=$(NDK_PATH)/platforms/android-9/arch-arm/usr/lib
STLLib=$(NDK_PATH)/sources/cxx-stl/stlport/libs/armeabi/
CFLAGS = -I$(NDK_PATH)\platforms\$(PLATFORMS)\arch-arm\usr\include -I$(NDK_PATH)/sources/cxx-stl/stlport/stlport -If:/ProgramTool/OpenPro/KKPlayer/ffmpeg/include
