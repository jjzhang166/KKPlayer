...
//#include  "../../MangageTrade/DuiLib/UIlib.h"  //"../MangageTrade/DuiLib/UIlib.h"
///////////////////////////////////////////////////////////////////////////////
...
// message loop
	int Run()
	{
		...
		for(;;)
		{
          ...
          //if( m_msg.message!=WM_CLOSE &&m_msg.wParam!=WM_QUIT&&!DuiLib::CPaintManagerUI::TranslateMessage(&m_msg))
		  {
