...
HWND SDL_ParentWindow = NULL;
int  no_win_border=0;
int SDL_WindowStyle=WS_OVERLAPPED|WS_CAPTION|WS_SYSMENU|WS_MINIMIZEBOX;
...
WORD *gamma_saved = NULL;
 ...
 void SetSDL_WindowParent(int Parent)
{
SDL_ParentWindow=(HWND)Parent;
}
void SetSDL_WindowStyle(int Style)
{
   no_win_border=Style;
}
